...
function createSidebar(articles) {
	// Login-Formular
	var sidebar = '<label for="login" class="col-6">Login</label> <input class="col-6" id="login" name="login" type="text" size="12" /><br>'
...
function createTagCloud(articles) {
	...
	for (tag in tagMap) {
		...
		tagcloud += '<a class="tag-' + size + '" href="tagliste.html">' + tag + '</a> ';
	}
